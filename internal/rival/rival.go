...
// Si la calibración (issue #10) queda fuera de rango, ajustar aquí y medir de nuevo.
var Velocidades = [4]float64{0, 1.4, 2.4, 3.6}

// umbral: zona muerta vertical en píxeles.
// Nivel más alto = umbral menor = rival más reactivo.
var umbral = [4]float64{0, 50.0, 20.0, 4.0}
